...
import DayTimePickerModalContent from './DayTimePickerModalContent';
import { useHeaderBackgroundColor, useHeaderColorIsLight } from '../utils';
export function DayTimePickerModal(props) {
  ...
  }), /*#__PURE__*/React.createElement(DayTimePickerModalContent, _extends({}, rest, {
...
export default /*#__PURE__*/React.memo(DayTimePickerModal);
