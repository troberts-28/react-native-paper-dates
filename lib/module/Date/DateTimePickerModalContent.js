...
export function DatePickerModalContent(props) {
  ...
  const [displayMode, setDisplayMode] = React.useState(undefined); // Initialize display Mode according the hours value
  ...
  const onInnerChangeDate = React.useCallback(params => {
    ...
    const date = params.date ? new Date((_params$date = params.date) === null || _params$date === void 0 ? void 0 : _params$date.getTime()) : new Date();
    ...
    if (state.endDate) {
      var _params$date2, _endDate, _endDate2;

      endDate = params.date ? new Date((_params$date2 = params.date) === null || _params$date2 === void 0 ? void 0 : _params$date2.getTime()) : new Date();
  ...
  return /*#__PURE__*/React.createElement(View, {
    ...
    startYear: startYear,
    endYear: endYear
  })), /*#__PURE__*/React.createElement(DisplayModeContext.Provider, {
    value: {
      mode: displayMode,
