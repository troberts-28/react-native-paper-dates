...
import { toHourInputFormat, toHourOutputFormat, circleSize, clockTypes, getTimeInputTypeIcon, reverseInputTypes } from '../Time/timeUtils';
...
export function DateTimePickerModalContent(props) {
  ...
  const [inputType, setInputType] = React.useState(initialInputType ?? 'keyboard');
  ...
  })) : null, !hideTimePicker ? /*#__PURE__*/React.createElement(DisplayModeContext.Provider, {
    value: {
      mode: displayMode,
