...
function DayRange(_ref) {
  ...
  if (inRange || isCrop) {
    return /*#__PURE__*/React.createElement(_reactNative.View, {
      ...
      style: [{
        backgroundColor: selectColor,
        minWidth: _dateUtils.calendarDaySize,
        minHeight: _dateUtils.calendarDaySize
...
const styles = _reactNative.StyleSheet.create({
  leftRadius: {
    borderBottomLeftRadius: _dateUtils.calendarDaySize / 2,
    borderTopLeftRadius: _dateUtils.calendarDaySize / 2
  },
  rightRadius: {
    borderBottomRightRadius: _dateUtils.calendarDaySize / 2,
    borderTopRightRadius: _dateUtils.calendarDaySize / 2
  },
  rangeRootBoth: {
    borderRadius: _dateUtils.calendarDaySize / 2
  },
  flex1: {
    flex: 1
  },
